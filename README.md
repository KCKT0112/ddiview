...
Please build with Qt 6.8.2. Should work with databases ranging from Version 3 to 5. If a certain database breaks the program, please contact me privately with the database file.
